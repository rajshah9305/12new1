...
const studios = [
  {
    ...
    subtitle: "GENERATION",
    description:
      "Create compelling content, articles, and marketing copy with advanced AI text generation powered by state-of-the-art language models.",
  ...
  },
  {
    ...
    subtitle: "GENERATION",
    description:
      "Generate, debug, and optimize code across multiple programming languages with intelligent suggestions and best practices.",
  ...
  },
  {
    ...
    subtitle: "AI",
    description:
      "Analyze, summarize, and extract insights from documents and complex data sources with advanced natural language processing.",
  ...
  },
  {
    ...
    subtitle: "WRITING",
    description:
      "Craft engaging stories, poetry, screenplays, and creative content with AI that understands narrative structure and style.",
...
export default function StudioSelectorRefined() {
  ...
  return (
    <section ref={sectionRef} className="px-6 py-32 bg-gray-50 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
            ...
            >
              ...
              >
                <CardContent className="p-8 h-full flex flex-col">
                  ...
                  >
                    <studio.icon className={`w-8 h-8 ${studio.featured ? "text-white" : "text-white"}`} />
                  </div>
                  ...
                  {(activeStudio === studio.id || studio.featured) && (
                    <div className={`p-4 rounded-lg mb-6 ${studio.featured ? "bg-black/20" : "bg-gray-100"}`}>
                  ...
                  {activeStudio === studio.id && (
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      <div className="text-center">
                        <div className={`text-lg font-black ${studio.textColor}`}>{studio.stats.accuracy}</div>
                        <div className="text-xs text-gray-500 uppercase">Accuracy</div>
                      </div>
                      <div className="text-center">
                        <div className={`text-lg font-black ${studio.textColor}`}>{studio.stats.speed}</div>
                        <div className="text-xs text-gray-500 uppercase">Speed</div>
                      </div>
                      <div className="text-center">
                        <div className={`text-lg font-black ${studio.textColor}`}>{studio.stats.satisfaction}</div>
                  ...
                  {studio.featured && (
                    <div className="absolute -top-3 -right-3">
                      <div className="bg-black text-white px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider flex items-center">
        ...
        <div className="text-center mt-20">
          ...
          <Button
            size="lg"
            variant="outline"
            className="border-2 border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white px-8 py-4 font-bold uppercase tracking-wider bg-transparent"
          >
