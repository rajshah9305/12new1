...
export default function ProcessFlowRefined() {
  ...
  return (
    <section ref={sectionRef} className="px-6 py-32 bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-orange-500/5 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="relative">
          {/* Connection Lines */}
          <div className="hidden lg:block absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent transform -translate-y-1/2 z-0"></div>
              ...
              >
                ...
                >
                  <CardContent className="p-8 text-center relative">
                    {/* Step Number */}
                    <div
                      className={`absolute -top-6 left-1/2 transform -translate-x-1/2 w-12 h-12 rounded-full flex items-center justify-center text-white font-black text-lg transition-all duration-500 ${
                        completedSteps.includes(step.id) ? "bg-green-500" : `bg-gradient-to-br ${step.color}`
                      }`}
                    >
                      {completedSteps.includes(step.id) ? <CheckCircle className="w-6 h-6" /> : step.step}
                    </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <h4 className="text-lg font-bold text-gray-600 mb-4">{step.subtitle}</h4>
        ...
        <div className="text-center mt-20">
          ...
          >
            <p className="text-gray-600 mb-6 text-lg">Ready to experience the future of AI creativity?</p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="bg-gradient-to-r from-blue-500 to-orange-500 text-white px-8 py-4 rounded-lg font-bold uppercase tracking-wider hover:shadow-lg transition-all duration-300 hover:scale-105">
                START YOUR JOURNEY
              </button>
              <button className="border-2 border-gray-300 text-gray-700 hover:border-orange-500 hover:text-orange-500 px-8 py-4 rounded-lg font-bold uppercase tracking-wider transition-all duration-300">
                WATCH DEMO
              </button>
            </div>
          </div>
